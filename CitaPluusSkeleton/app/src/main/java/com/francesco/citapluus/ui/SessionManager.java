...
public class SessionManager {
    ...
    private static final String K_EMAIL       = "email";  // AÑADIDO: Constante para email
    ...
    public boolean isLoggedIn() { return sp.getBoolean(K_LOGGED_IN, false); }
    
    public void setLoggedIn(boolean value) { 
        sp.edit().putBoolean(K_LOGGED_IN, value).apply(); 
    }
    
    public void saveContrasena(String pass) {
        sp.edit().putString(K_PASS, pass).apply();
    }
    ...
    public void setCentroSalud(String nombre, String direccion, double lat, double lng) {
        ...
        if (!dni.isEmpty()) {
            ...
            centroData.put("centroNombre", nombre);
            centroData.put("centroDireccion", direccion);
            centroData.put("centroLat", lat);
            centroData.put("centroLng", lng);
            centroData.put("fechaAsignacion", System.currentTimeMillis());
            
            db.collection("usuarios")
                    .document(dni)
                    .update(centroData)
                    .addOnSuccessListener(aVoid -> 
                        Log.d("SessionManager", "Centro de salud guardado en Firebase"))
                    .addOnFailureListener(e -> 
                        Log.e("SessionManager", "Error al guardar centro en Firebase", e));
        }
    }
    ...
    public void savePaciente(Paciente p) {
        ...
        sp.edit()
                ...
                .putString(K_EMAIL, safe(p.getEmail()))  // AÑADIDO: Guardar email
    ...
    public Paciente getPaciente() {
        return new Paciente(
                ...
                sp.getString(K_EMAIL, ""),  // AÑADIDO: Recuperar email
                sp.getString(K_CIPA, ""),
                sp.getString(K_CP, ""),
    ...
    // AÑADIDO: Método getter para email
    public String getEmail() {
        return sp.getString(K_EMAIL, "");
    }
    
    // AÑADIDO: Método setter para email
    public void setEmail(String email) {
        sp.edit().putString(K_EMAIL, safe(email)).apply();
    }
