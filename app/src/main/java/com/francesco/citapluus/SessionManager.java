...
public class SessionManager {
    ...
    /** Firma que tu RegistroDialogFragment está usando. */
    public void createSession(String dni,
                              String nombre,
                              String apPaterno,
                              String apMaterno,
                              String tipoSangre,
    ...
    public String getNombreCompleto() {
        ...
        String ap1 = getApellidoPaterno();
        String ap2 = getApellidoMaterno();
        String full = (nombre + " " + ap1 + " " + ap2).trim();
    ...
    public void addFavorito(FavoritePlace f) {
        ...
        for (FavoritePlace x : list) {
            if (f.id.equals(x.id)) return; // ya existe
        }
        list.add(f);
        saveFavoritos(list);
    }
