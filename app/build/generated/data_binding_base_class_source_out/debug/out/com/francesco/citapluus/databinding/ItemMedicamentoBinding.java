...
public final class ItemMedicamentoBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView textResumen;

  private ItemMedicamentoBinding(@NonNull MaterialCardView rootView, @NonNull TextView textNombre,
      @NonNull TextView textResumen) {
    this.rootView = rootView;
    this.textNombre = textNombre;
    this.textResumen = textResumen;
  }
  ...
  public static ItemMedicamentoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.textResumen;
      TextView textResumen = ViewBindings.findChildViewById(rootView, id);
      if (textResumen == null) {
        break missingId;
      }

      return new ItemMedicamentoBinding((MaterialCardView) rootView, textNombre, textResumen);
    }
